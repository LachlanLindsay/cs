...
import com.lachlanlindsay.Sort.RadixSortInts;
import com.lachlanlindsay.Sort.RadixSortStrings;
import com.lachlanlindsay.Sort.RadixUtil;
...
public class RadixSortIntsTest {
    ...
    public void testGetDigit() {
        assertEquals(6, RadixUtil.getCountArrayIndexPosition(0, 123456, 10));
